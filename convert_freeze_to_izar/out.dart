...
class ScaleTeamIsar {
  ...
  const ScaleTeamIsar({this.id, this.scaleId, this.comment, this.createdAt, this.updatedAt, this.feedback, this.finalMark, this.flag, this.beginAt, this.correcteds, this.corrector, this.truant, this.filledAt, this.questionsWithAnswers, this.scale, this.team, this.feedbacks, });
   ...
   ScaleTeam toFreezed() => ScaleTeam(
      ...
      flag: flag?.toFreezed(),
      beginAt: beginAt,
      correcteds: correcteds?.map((e) => e.toFreezed()).toList(),
...
class ScaleClassIsar {
  ...
  final List<LanguageIsar>? languages;
  final List<FlagIsar>? flags;
  final bool? free;

  const ScaleClassIsar({this.id, this.evaluationId, this.name, this.isPrimary, this.comment, this.introductionMd, this.disclaimerMd, this.guidelinesMd, this.createdAt, this.correctionNumber, this.duration, this.manualSubscription, this.languages, this.flags, this.free, });
   ...
   factory ScaleClassIsar.fromFreezed(ScaleClass? objet) => ScaleClassIsar (
      ...
      languages: objet?.languages?.map((e) => LanguageIsar.fromFreezed(e)).toList(),
   ...
   ScaleClass toFreezed() => ScaleClass(
      ...
      languages: languages?.map((e) => e.toFreezed()).toList(),
