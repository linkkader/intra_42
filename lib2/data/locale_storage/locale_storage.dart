...
class LocaleStorage{
  ...
  Future<void> init() async {
    ...
    var schemas = [TokenBodyIsarSchema, UserIsarSchema, ImgSchema, BlackHoleIsarSchema, DateTimeIsarSchema, ExpertiseIsarSchema, IntIsarSchema, StringIsarSchema, NotificationIsarSchema, ScaleTeamIsarSchema, User2IsarSchema, ProjectsUserIsarCollectionSchema];

    try{
      App.log.w("LocaleStorage", "init");
      App.log.w("LocaleStorage",  (await getTemporaryDirectory()).path);
      App.log.w("LocaleStorage",  Directory.systemTemp);
      App.log.w("LocaleStorage",  Directory.current);
      ...
      App.log.e("LocaleStorage", _.toString());
      //for testing when temp dir is not available
      _isar = await Isar.open(
        [
          ...schemas,
        ],
