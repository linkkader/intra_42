...
abstract class $ScaleTeamCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'correcteds') dynamic correcteds,
      Corrector? corrector,
      Truant? truant,
...
class _$ScaleImpl implements _Scale {
  const _$ScaleImpl(
      ...
      @JsonKey(name: 'correcteds') this.correcteds,
      this.corrector,
      this.truant,
...
abstract class _Scale implements ScaleTeam {
  const factory _Scale(
      ...
      @JsonKey(name: 'correcteds') final dynamic correcteds,
      final Corrector? corrector,
      final Truant? truant,
      ...
      final ScaleClass? scale,
      final Team? team,
      final List<Feedback>? feedbacks}) = _$ScaleImpl;
...
abstract class _Feedback implements Feedback {
  const factory _Feedback(
      ...
      final String? comment,
      final int? rating,
      @JsonKey(name: 'created_at') final DateTime? createdAt}) = _$FeedbackImpl;
...
/// @nodoc
abstract class _$$CorrectorImplCopyWith<$Res>
    implements $CorrectorCopyWith<$Res> {
  factory _$$CorrectorImplCopyWith(
          _$CorrectorImpl value, $Res Function(_$CorrectorImpl) then) =
      __$$CorrectorImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int? id, String? login, String? url});
}
...
/// @nodoc
class __$$CorrectorImplCopyWithImpl<$Res>
    extends _$CorrectorCopyWithImpl<$Res, _$CorrectorImpl>
    implements _$$CorrectorImplCopyWith<$Res> {
  __$$CorrectorImplCopyWithImpl(
      _$CorrectorImpl _value, $Res Function(_$CorrectorImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$CorrectorImpl implements _Corrector {
  const _$CorrectorImpl({this.id, this.login, this.url});

  factory _$CorrectorImpl.fromJson(Map<String, dynamic> json) =>
      _$$CorrectorImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CorrectorImplCopyWith<_$CorrectorImpl> get copyWith =>
      __$$CorrectorImplCopyWithImpl<_$CorrectorImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CorrectorImplToJson(
      this,
    );
  }
}
...
abstract class _Corrector implements Corrector {
  const factory _Corrector(
      {final int? id,
      final String? login,
      final String? url}) = _$CorrectorImpl;

  factory _Corrector.fromJson(Map<String, dynamic> json) =
      _$CorrectorImpl.fromJson;
