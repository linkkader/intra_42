...
/// @nodoc
abstract class _$$_TokenBodyCopyWith<$Res> implements $TokenBodyCopyWith<$Res> {
  factory _$$_TokenBodyCopyWith(
          _$_TokenBody value, $Res Function(_$_TokenBody) then) =
      __$$_TokenBodyCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'access_token') String? accessToken,
...
/// @nodoc
class __$$_TokenBodyCopyWithImpl<$Res>
    extends _$TokenBodyCopyWithImpl<$Res, _$_TokenBody>
    implements _$$_TokenBodyCopyWith<$Res> {
  __$$_TokenBodyCopyWithImpl(
      _$_TokenBody _value, $Res Function(_$_TokenBody) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_TokenBody implements _TokenBody {
  const _$_TokenBody(
  ...
  factory _$_TokenBody.fromJson(Map<String, dynamic> json) =>
      _$$_TokenBodyFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TokenBodyCopyWith<_$_TokenBody> get copyWith =>
      __$$_TokenBodyCopyWithImpl<_$_TokenBody>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TokenBodyToJson(
      this,
    );
  }
}
...
abstract class _TokenBody implements TokenBody {
  const factory _TokenBody(
      ...
      final String? scope,
      @JsonKey(name: 'created_at') final int? createdAt}) = _$_TokenBody;

  factory _TokenBody.fromJson(Map<String, dynamic> json) =
      _$_TokenBody.fromJson;
