...
class _$ClusterItemImpl implements _ClusterItem {
  ...
  factory _$ClusterItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$ClusterItemImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$ClusterItemImplToJson(
      this,
    );
  }
}
...
abstract class _ClusterItem implements ClusterItem {
  const factory _ClusterItem(
      ...
      final String? image,
      @JsonKey(name: 'campus_id') final int? campusId}) = _$ClusterItemImpl;

  factory _ClusterItem.fromJson(Map<String, dynamic> json) =
      _$ClusterItemImpl.fromJson;
