...
mixin _$ProjectData {
  ...
  List<By>? get by => throw _privateConstructorUsedError;
...
class _$ProjectDataImpl implements _ProjectData {
  ...
  @override
  String toString() {
    return 'ProjectData(state: $state, finalMark: $finalMark, id: $id, kind: $kind, name: $name, x: $x, y: $y, by: $by, projectId: $projectId, difficulty: $difficulty, duration: $duration, rules: $rules, description: $description, slug: $slug)';
  }
...
class _$ByImpl implements _By {
  ...
  @override
  String toString() {
    return 'By(parentId: $parentId, points: $points)';
  }
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, parentId, const DeepCollectionEquality().hash(_points));
