...
class LocaleStorage {
  ...
  Future<void> init() async {
    ...
    _isar = await Isar.open([TokenBodyIsarSchema, UserIsarSchema, ImgSchema, BlackHoleIsarSchema, DateTimeIsarSchema, IntIsarSchema, CampusIsarCollectionSchema], name: "isar", directory: "isar");
